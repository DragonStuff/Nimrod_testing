...
N_NOINLINE(void, greetingsInit)(void) {
	...
	asgnRefNoCycle((void**) &name_84005, readline_10484(stdin));
	nimln(4, "greetings.nim");
	printf("%s%s%s\015\012", (((NimStringDesc*) &TMP126))->data, (name_84005)->data, (((NimStringDesc*) &TMP127))->data);
	popFrame();
}
